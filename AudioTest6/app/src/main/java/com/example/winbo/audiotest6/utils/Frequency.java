...
import com.example.winbo.audiotest6.utils.common.Complex;
import com.example.winbo.audiotest6.utils.common.FFT;
...
public class Frequency {
    public static double getFreq(byte[] signal) {
        ...
        //这里的22050是采样率
        double freq = mPeakPos * 22050 / 4096;
...
//            Log.i("winbo", "absNormalizedSignal:" + freq);
    ...
    public double[] calculateFFT(byte[] signal) {
        ...
        double freq = mPeakPos * 44100 / 8196;
